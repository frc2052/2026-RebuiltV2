...
public class HubShootingTable extends ShootingTableBase {
  ...
  static {
    ...
    shootingTable.put(Meters.of(2), new Pair<>(RotationsPerSecond.of(31), Degrees.of(2.5)));
    ...
    shootingTable.put(Meters.of(3.5), new Pair<>(RotationsPerSecond.of(32), Degrees.of(6.6)));
    shootingTable.put(Meters.of(4), new Pair<>(RotationsPerSecond.of(36), Degrees.of(7.1)));
    shootingTable.put(Meters.of(4.5), new Pair<>(RotationsPerSecond.of(40), Degrees.of(8.5)));
