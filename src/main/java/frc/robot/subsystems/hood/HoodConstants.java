...
public class HoodConstants {
    public static final Angle HOOD_MIN_ANGLE = Degrees.of(0);
    public static final Angle HOOD_MAX_ANGLE = Degrees.of(30);
    ...
    static {
      ...
      SERVO_CONSTANTS.leaderTalonFXConstants.id = Ports.HOOD_MOTOR.getFirst();
      SERVO_CONSTANTS.leaderTalonFXConstants.bus = Ports.HOOD_MOTOR.getSecond();
      SERVO_CONSTANTS.counterClockwisePositive = false;

      SERVO_CONSTANTS.slot1kP = 40;
      SERVO_CONSTANTS.slot1kD = 0.2;
      SERVO_CONSTANTS.cruiseVelocity = 1080;
      SERVO_CONSTANTS.acceleration = 3600;
      SERVO_CONSTANTS.sensorToMechanismRatio = 0;
      SERVO_CONSTANTS.rotorToSensorRatio = 0;
    ...
    static {
      ...
      ENCODER_CONSTANTS.config.MagnetSensor.AbsoluteSensorDiscontinuityPoint = 1.0;
      ENCODER_CONSTANTS.config.MagnetSensor.SensorDirection =
