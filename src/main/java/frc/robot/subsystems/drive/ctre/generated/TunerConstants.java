...
public class TunerConstants {
  // selected gearing, either R1, R2, or R3
  private static final DrivetrainGearing gearing = DrivetrainGearing.R1;
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(10.0).withKI(0).withKD(0).withKS(1.5).withKV(0.124);
  ...
  private static final boolean driveFOC = true;
  ...
  // This needs to be tuned to your individual robot
  // sds spec sheet
  public static final LinearVelocity r1LinearVelocity = FeetPerSecond.of(driveFOC ? 14.4 : 14.9);
  public static final LinearVelocity r2LinearVelocity = FeetPerSecond.of(driveFOC ? 16.8 : 17.4);
  public static final LinearVelocity r3LinearVelocity = FeetPerSecond.of(driveFOC ? 19.2 : 19.9);
  public static final LinearVelocity kSpeedAt12Volts =
      switch (gearing) {
        case R1 -> r1LinearVelocity;
        case R2 -> r2LinearVelocity;
        case R3 -> r3LinearVelocity;
      };
  ;
  ...
  private static final double r1Gearing = (54.0 / 12) * (25.0 / 32) * (30.0 / 15);
  private static final double r2Gearing = (54.0 / 14) * (25.0 / 32) * (30.0 / 15);
  private static final double r3Gearing = (54.0 / 16) * (25.0 / 32) * (30.0 / 15);
  ...
  private static final Angle kBackRightEncoderOffset =
      Rotations.of(0.301514); // ben's offset: -0.442626953125);
