...
public class ShotProfile {
    ...
    public ShotProfile(AimingParameters aimingParameters, TargetParameters targetParameters, ShotInformation shotInformation) {
    ...
    public static class AimingParameters {
        ...
        public AimingParameters(AngularVelocity shooterVelocity, Angle hoodAngle, Rotation2d robotRotation) {
