...
public class FieldConstants {
  ...
  public static final Distance tagToHubDistance = Meters.of(0.59);
  ...
  public static final class FieldLocations {
    public static final Translation2d BLUE_ALLIANCE_HUB_LOCATION =
        new Translation2d(Inches.of(181.5), Inches.of(158.3));
    ...
    public static final Translation2d RED_ALLIANCE_HUB_LOCATION =
        new Translation2d(Inches.of(651 - 181.5), Inches.of(158.3));
    public static final Translation2d RED_ALLIANCE_OUTPOST_SIDE_FEEDING_AIMING_POINT =
        new Translation2d(
  ...
  public static final class FieldRegions {
    public static final RectangleRegion BLUE_ALLIANCE_ZONE =
        new RectangleRegion(
            new Translation2d(Meters.of(0), Meters.of(0)),
            new Translation2d(
                Meters.of(LinesVertical.allianceZone).plus(Inches.of(26)), Meters.of(fieldWidth)));

    public static final RectangleRegion RED_ALLIANCE_ZONE =
        new RectangleRegion(
            new Translation2d(
                Meters.of(fieldLength - LinesVertical.allianceZone).minus(Inches.of(26)),
                Meters.of(0)),
            new Translation2d(Meters.of(fieldLength), Meters.of(fieldWidth)));

    public static final RectangleRegion NEUTRAL_ZONE =
        new RectangleRegion(
            new Translation2d(
                Meters.of(LinesVertical.allianceZone).plus(Inches.of(26)), Meters.of(0)),
            new Translation2d(
                Meters.of(fieldLength - LinesVertical.allianceZone).minus(Inches.of(26)),
                Meters.of(fieldWidth)));

    public static final RectangleRegion BLUE_OUTPOST_SIDE =
        new RectangleRegion(
            new Translation2d(Meters.of(0), Meters.of(0)),
            new Translation2d(Meters.of(fieldLength), Meters.of(fieldWidth / 2.0)));

    public static final RectangleRegion RED_OUTPOST_SIDE =
        new RectangleRegion(
            new Translation2d(Meters.of(0), Meters.of(fieldWidth / 2.0)),
            new Translation2d(Meters.of(fieldLength), Meters.of(fieldWidth)));
    public static final RectangleRegion BLUE_DEPOT_SIDE = RED_OUTPOST_SIDE;
    public static final RectangleRegion RED_DEPOT_SIDE = BLUE_OUTPOST_SIDE;

    // Trench regions
    public static final RectangleRegion BLUE_OUTPOST_TRENCH =
        new RectangleRegion(
            new Translation2d(Meters.of(LinesVertical.allianceZone), Meters.of(0)),
            new Translation2d(
                Meters.of(LinesVertical.allianceZone + LeftTrench.depth),
                Meters.of(LeftTrench.width)));
    public static final RectangleRegion RED_OUTPOST_TRENCH =
        new RectangleRegion(
            new Translation2d(
                Meters.of(fieldLength - LinesVertical.allianceZone - LeftTrench.depth),
                Meters.of(fieldWidth - LeftTrench.width)),
            new Translation2d(
                Meters.of(fieldLength - LinesVertical.allianceZone), Meters.of(fieldWidth)));
    public static final RectangleRegion BLUE_DEPOT_TRENCH =
        new RectangleRegion(
            new Translation2d(
                Meters.of(LinesVertical.allianceZone), Meters.of(fieldWidth - LeftTrench.width)),
            new Translation2d(
                Meters.of(LinesVertical.allianceZone + LeftTrench.depth),
                Meters.of(fieldWidth - LeftTrench.width)));
    public static final RectangleRegion RED_DEPOT_TRENCH =
        new RectangleRegion(
            new Translation2d(
                Meters.of(fieldLength - LinesVertical.allianceZone - LeftTrench.depth),
                Meters.of(0)),
            new Translation2d(
                Meters.of(fieldLength - LinesVertical.allianceZone), Meters.of(LeftTrench.width)));
    public static final CombinedRegion TRENCH_REGIONS =
        new CombinedRegion(
            BLUE_OUTPOST_TRENCH, RED_OUTPOST_TRENCH, BLUE_DEPOT_TRENCH, RED_DEPOT_TRENCH);
  }

  public static final class LineDistances {
    public static final Distance ALLIANCE_STARTING_LINE = Inches.of(181.5);
    public static final Distance CENTER_LINE = Inches.of(325);
    public static final Distance OPPOSING_ALLIANCE_STARTING_LINE = Inches.of((325 * 2) - 181.5);
  }
}
